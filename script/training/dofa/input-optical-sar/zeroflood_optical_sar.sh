...
# ======== Slurm setting
#SBATCH -J pga_ft_df_zf
#SBATCH --output=pga_ft_df_zf_%j.out
#SBATCH --error=pga_ft_df_zf_%j.err
...
MODEL_ROOT=/dss/dsstbyfs02/scratch/07/di54rur/pangaea-bench/pretrained_models/DOFA_ViT_base_e100.pth
