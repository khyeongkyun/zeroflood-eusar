...
# ======== Slurm setting
#SBATCH -J pga_ft_cr_zf
#SBATCH --output=pga_ft_cr_zf_%j.out
#SBATCH --error=pga_ft_cr_zf_%j.err
...
MODEL_ROOT=/dss/dsstbyfs02/scratch/07/di54rur/pangaea-bench/pretrained_models/CROMA_large.pt
