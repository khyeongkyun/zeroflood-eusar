...
# ======== Slurm setting
#SBATCH -J pga_ft_tr_b_zf_tim_chain_d
#SBATCH --output=pga_ft_tr_b_zf_tim_chain_d_%j.out
#SBATCH --error=pga_ft_tr_b_zf_tim_chain_d_%j.err
