...
# ======== Slurm setting
#SBATCH -J pga_ft_tr_b_zf_tim_chain_l
#SBATCH --output=pga_ft_tr_b_zf_tim_chain_l_%j.out
#SBATCH --error=pga_ft_tr_b_zf_tim_chain_l_%j.err
