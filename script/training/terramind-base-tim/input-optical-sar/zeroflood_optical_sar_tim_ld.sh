...
# ======== Slurm setting
#SBATCH -J pga_ft_tr_b_zf_tim_chain_ld
#SBATCH --output=pga_ft_tr_b_zf_tim_chain_ld_%j.out
#SBATCH --error=pga_ft_tr_b_zf_tim_chain_ld_%j.err
