...
# ======== Slurm setting
#SBATCH -J pga_ft_tr_b_zf_tim_chain_s
#SBATCH --output=pga_ft_tr_b_zf_tim_chain_s_%j.out
#SBATCH --error=pga_ft_tr_b_zf_tim_chain_s_%j.err
